...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(
        ...
        [new RemoveFuncCallArg('mysql_pconnect', 3), new RemoveFuncCallArg('mysql_connect', 3), new RemoveFuncCallArg(
            'mysql_connect',
            4
        )]
    );
    ...
    $rectorConfig->ruleWithConfiguration(
        ...
        [new SwapFuncCallArguments('mysql_query', [1, 0]), new SwapFuncCallArguments('mysql_real_escape_string', [
            1,
            0,
        ]), new SwapFuncCallArguments(
            'mysql_select_db',
            [1, 0]
